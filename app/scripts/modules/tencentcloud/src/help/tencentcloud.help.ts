...
const helpContents: { [key: string]: string } = {
  ...
  'tencentcloud.associateElasticIp.type': `<p><b>Type</b> of elastic IP to associate:'
      <ul>
        <li><b>standard</b> is usable in CVM Classic</li>
  ...
  'tencentcloud.blockDeviceMappings.useSource': `
    ...
    <p>In the event that there is no existing server group, the
        <a target="_blank" href="https://github.com/spinnaker/clouddriver/blob/master/clouddriver-tencent/src/main/groovy/com/netflix/spinnaker/clouddriver/tencent/deploy/BlockDeviceConfig.groovy">defaults</a>
  ...
  'tencentcloud.blockDeviceMappings.useDefaults':
    '<p>Spinnaker will use the <a target="_blank" href="https://github.com/spinnaker/clouddriver/blob/master/clouddriver-tencent/src/main/groovy/com/netflix/spinnaker/clouddriver/tencent/deploy/BlockDeviceConfig.groovy">default block device mappings</a> for the selected instance type when deploying a new server group.</p>',
  ...
  'tencentcloude.targetGroup.attributes.healthCheckPort.trafficPort':

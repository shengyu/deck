...
export const name = TENCENTCLOUD_PIPELINE_STAGES_CLONESERVERGROUP_TENCENTCLOUDCLONESERVERGROUPSTAGE;
module(TENCENTCLOUD_PIPELINE_STAGES_CLONESERVERGROUP_TENCENTCLOUDCLONESERVERGROUPSTAGE, [])
  .config(function() {
  ...
  .controller('tencentCloudCloneServerGroupStageCtrl', [
    '$scope',
    function($scope) {

...
export class ServerGroupLoadBalancers
  ...
  private listenerChanged(forwardLoadBalancer: ITencentCloudForwardLoadBalancer, listenerId: string) {
  ...
  private domainChanged = (forwardLoadBalancer: ITencentCloudForwardLoadBalancer, domain: string) => {
    const { listenerLocationMap } = this.state;
    forwardLoadBalancer.locationId = '';
  ...
  private urlChanged = (forwardLoadBalancer: ITencentCloudForwardLoadBalancer, url: string) => {
    const { listenerLocationMap } = this.state;
    const listenerLocation = listenerLocationMap[forwardLoadBalancer.listenerId];
  ...
  public componentWillReceiveProps(nextProps: IServerGroupLoadBalancersProps): void {
    ...
    if (
      ...
      this.setState({
        listenerLocationMap: {
          ...this.state.listenerLocationMap,
          ...forwardLoadBalancers.reduce((p: ITencentCloudLocationMap, c) => {

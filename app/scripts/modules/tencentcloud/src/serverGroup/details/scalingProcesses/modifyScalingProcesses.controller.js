...
export const TENCENTCLOUD_SERVERGROUP_DETAILS_SCALINGPROCESSES_MODIFYSCALINGPROCESSES_CONTROLLER =
  'spinnaker.tencentcloud.serverGroup.details.autoscaling.process.controller';
module(TENCENTCLOUD_SERVERGROUP_DETAILS_SCALINGPROCESSES_MODIFYSCALINGPROCESSES_CONTROLLER, []).controller(
  'tencentModifyScalingProcessesCtrl',
  [
    '$scope',
    '$uibModalInstance',
    'application',

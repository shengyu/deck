...
export const TENCENTCLOUD_SERVERGROUP_DETAILS_SCALINGPOLICY_UPSERT_ALARM_DIMENSIONSEDITOR_COMPONENT =
  'spinnaker.tencentcloud.serverGroup.details.scalingPolicy.dimensionEditor';
export const name = TENCENTCLOUD_SERVERGROUP_DETAILS_SCALINGPOLICY_UPSERT_ALARM_DIMENSIONSEDITOR_COMPONENT;
module(TENCENTCLOUD_SERVERGROUP_DETAILS_SCALINGPOLICY_UPSERT_ALARM_DIMENSIONSEDITOR_COMPONENT, []).component(
  'dimensionsEditor',
  {
    bindings: {
      alarm: '=',

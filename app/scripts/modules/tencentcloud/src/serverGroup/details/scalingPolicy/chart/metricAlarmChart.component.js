...
export const TENCENTCLOUD_SERVERGROUP_DETAILS_SCALINGPOLICY_CHART_METRICALARMCHART_COMPONENT =
  'spinnaker.tencentcloud.serverGroup.details.scalingPolicy.metricAlarmChart.component';
export const name = TENCENTCLOUD_SERVERGROUP_DETAILS_SCALINGPOLICY_CHART_METRICALARMCHART_COMPONENT; // for backwards compatibility
module(TENCENTCLOUD_SERVERGROUP_DETAILS_SCALINGPOLICY_CHART_METRICALARMCHART_COMPONENT, ['n3-line-chart']).component(
  'metricAlarmChart',
  {
    bindings: {
      alarm: '=',
      ...
      stats: '=?', // object - this is gross - used to backfill units when statistics calls return, since Tencent Cloud API does

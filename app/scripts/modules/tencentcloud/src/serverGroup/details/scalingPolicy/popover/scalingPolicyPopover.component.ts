...
import { TENCENTCLOUD_SERVERGROUP_DETAILS_SCALINGPOLICY_CHART_METRICALARMCHART_COMPONENT } from '../chart/metricAlarmChart.component';
...
module(SCALING_POLICY_POPOVER, [
  TENCENTCLOUD_SERVERGROUP_DETAILS_SCALINGPOLICY_CHART_METRICALARMCHART_COMPONENT,
]).component('tencentCloudScalingPolicyPopover', scalingPolicyPopover);

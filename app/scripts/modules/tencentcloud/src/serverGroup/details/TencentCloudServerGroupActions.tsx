...
import { TencentCloudCloneServerGroupModal } from 'tencentcloud/serverGroup/configure/wizard/TencentCloudCloneServerGroupModal';
...
export class TencentCloudServerGroupActions extends React.Component<ITencentCloudServerGroupActionsProps> {
  ...
  private rollbackServerGroup = (): void => {
    ...
    ModalInjector.modalService.open({
      ...
      controller: 'tencentCloudRollbackServerGroupCtrl as ctrl',
      resolve: {

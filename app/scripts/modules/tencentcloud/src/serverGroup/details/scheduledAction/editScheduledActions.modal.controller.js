...
export const name = TENCENTCLOUD_SERVERGROUP_DETAILS_SCHEDULEDACTION_EDITSCHEDULEDACTIONS_MODAL_CONTROLLER;
module(TENCENTCLOUD_SERVERGROUP_DETAILS_SCHEDULEDACTION_EDITSCHEDULEDACTIONS_MODAL_CONTROLLER, []).controller(
  'tencentCloudEditScheduledActionsCtrl',
  [
    '$scope',
    '$uibModalInstance',
    'application',
